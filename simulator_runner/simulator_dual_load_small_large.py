...
class SimulatorRunner(simulator_pb2_grpc.SimServerServicer):
    ...
    def __init__(
        ...
        self.current_load = 0  # tracking current load
        return None
    ...
    def GetConfig(self, request, context):
        ...
        try:
            ...
            self.current_load = job_config["load"]
            ...
            try:
                ...
                if new_job_dict["job_arrival_time"] > simulator_time:
                    ...
                    if simulator_time % 14400 == 0:
                        # send two x the curent load in a single hour
                        for extra_jobs_to_add in range(int(4 * self.current_load)):
                            new_job_deep_copy = copy.deepcopy(new_job_dict)
                            new_job_deep_copy = self._clean_sim_job_second_work(
                                new_job_deep_copy
                            )
